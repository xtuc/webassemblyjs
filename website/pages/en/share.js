  ...
  render() {
    return (
      <Container>
        ...
        <script src="https://bundle.run/@webassemblyjs/wasm-gen@1.0.0-y.8" />
        <script src="https://bundle.run/@webassemblyjs/wasm-parser@1.0.0-y.8" />
        <script src="https://bundle.run/@webassemblyjs/wast-printer@1.0.0-y.8" />
