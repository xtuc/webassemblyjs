...
const symbolsByByte = {
  ...
  0x28: createSymbolObject("load", "i32", 1),
  0x29: createSymbolObject("load", "i64", 1),
  0x2a: createSymbolObject("load", "f32", 1),
  0x2b: createSymbolObject("load", "f64", 1),
  0x2c: createSymbolObject("load8_s", "i32", 1),
  0x2d: createSymbolObject("load8_u", "i32", 1),
  0x2e: createSymbolObject("load16_s", "i32", 1),
  0x2f: createSymbolObject("load16_u", "i32", 1),
  0x30: createSymbolObject("load8_s", "i64", 1),
  0x31: createSymbolObject("load8_u", "i64", 1),
  0x32: createSymbolObject("load16_s", "i64", 1),
  0x33: createSymbolObject("load16_u", "i64", 1),
  0x34: createSymbolObject("load32_s", "i64", 1),
  0x35: createSymbolObject("load32_u", "i64", 1),

  0x36: createSymbolObject("store", "i32", 1),
  0x37: createSymbolObject("store", "i64", 1),
  0x38: createSymbolObject("store", "f32", 1),
  0x39: createSymbolObject("store", "f64", 1),
  0x3a: createSymbolObject("store8", "i32", 1),
  0x3b: createSymbolObject("store16", "i32", 1),
  0x3c: createSymbolObject("store8", "i64", 1),
  0x3d: createSymbolObject("store16", "i64", 1),
  0x3e: createSymbolObject("store32", "i64", 1),
  ...
  0xa7: createSymbolObject("wrap", "i32"),
  0xa8: createSymbolObject("trunc_s", "i32"),
  0xa9: createSymbolObject("trunc_u", "i32"),
  0xaa: createSymbolObject("trunc_s", "i32"),
  0xab: createSymbolObject("trunc_u", "i32"),
  0xac: createSymbolObject("extend_s", "i64"),
  0xad: createSymbolObject("extend_u", "i64"),
  0xae: createSymbolObject("trunc_s", "i64"),
  0xaf: createSymbolObject("trunc_u", "i64"),
  0xb0: createSymbolObject("trunc_s", "i64"),
  0xb1: createSymbolObject("trunc_u", "i64"),
  0xb2: createSymbolObject("convert_s", "f32"),
  0xb3: createSymbolObject("convert_u", "f32"),
  0xb4: createSymbolObject("convert_s", "f32"),
  0xb5: createSymbolObject("convert_u", "f32"),
  0xb6: createSymbolObject("demote", "f32"),
  0xb7: createSymbolObject("convert_s", "f64"),
  0xb8: createSymbolObject("convert_u", "f64"),
  0xb9: createSymbolObject("convert_s", "f64"),
  0xba: createSymbolObject("convert_u", "f64"),
  0xbb: createSymbolObject("promote", "f64"),

  0xbc: createSymbolObject("reinterpret", "i32"),
  0xbd: createSymbolObject("reinterpret", "i64"),
  0xbe: createSymbolObject("reinterpret", "f32"),
  0xbf: createSymbolObject("reinterpret", "f64")
};
