...
describe("replace an import", () => {
  it("should replace the import", () => {
    const actualBinary = makeBuffer(
      encodeHeader(),
      encodeVersion(1),
      [0x02, 0x08, 0x01, 0x01, 0x6d, 0x01, 0x61, 0x03, 0x7f, 0x00, 0x00, 0x08],
      [0x04, 0x6e, 0x61, 0x6d, 0x65, 0x02, 0x01, 0x00]
    );
    ...
    const expectedBinary = makeBuffer(
      encodeHeader(),
      encodeVersion(1),
      [0x02, /* FIXME(sven): should 12 0x0c*/8, 0x01, 0x03, 0x66, 0x6f, 0x6f, 0x03, 0x62, 0x61, 0x72, 0x03],
      [0x7f, 0x00, 0x00, 0x08, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x02, 0x01, 0x00]
    );
