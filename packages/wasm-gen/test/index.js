...
const fixtures = [
...

  {
    ...
    node: t.global(t.globalType("i32", "var"), [
      t.objectInstruction("const", "i32", [t.numberLiteralFromRaw(1)]), t.instruction("end")
    ]),
...

  {
    ...
    node: t.func(null, t.signature([], []), [t.instruction("unreachable"), t.instruction("end")]),
...

  {
    ...
    node: t.elem(
      t.numberLiteralFromRaw(1),
      [t.objectInstruction("const", "i32", [t.numberLiteralFromRaw(2)]), t.instruction("end")],
